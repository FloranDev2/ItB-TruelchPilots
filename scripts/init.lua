local descriptiontext = "My pilots. Hope you like them."
local pilot_init = "pilots/init"


local mod = {
	id = "truelch_Pilots",
	name = "Truelch's Pilots",
	version = "1.0.0",
	dependencies = {
		modApiExt = "1.22",
		memedit = "1.1.5",
...
function mod:init()
	...
	--Mark
	require(self.scriptPath.."mark/mark_lib"):init()
...
function mod:load(options, version)
	...
	--Mark
	require(self.scriptPath.."mark/mark_lib"):load()
